...
public class RelationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (uri.equals(cp + "/Admin/Relation/Add")) {
            request.setAttribute("sclist", RelationDao.selectAll());
            request.setAttribute("studentlist", StudentDao.selectAll());
            request.setAttribute("courselist", CourseDao.selectAll());
            request.getRequestDispatcher("/admin/student_course.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (uri.equals(cp + "/Admin/Relation/Add")) {
            ...
            if (RelationDao.insert(sid,cid)) {
                response.sendRedirect(cp+"/Admin/Relation/Add");
            }else{
                response.sendRedirect(cp+"/Admin/Relation/Add?Failed");
            }
        }
    }
